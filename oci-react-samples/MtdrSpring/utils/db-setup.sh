...
create table TODOUSER.TODOSPRINT(
    ...
    sprint_status VARCHAR(10) CHECK (sprint_status IN ('Not Started', 'Open', 'Closed')),
...
CREATE TABLE TODOUSER.TODOITEM (
    ...
    item_deadline DATE, 
    item_status VARCHAR(20) CHECK (task_status IN ('Not Started', 'In Progress', 'Done')), 
...
INSERT INTO TODOUSER.TODOTASK (TASK_DESCRIPTION, TASK_STATUS, USER_ID, SPRINT_ID)
